...
public interface BakalariApi {
        ...
        Call<KomensResponse> getKomensReceived(@Header("Authorization") String authorization,
        ...
        @GET("api/3/homeworks")
        Call<HomeworksResponse> getHomeworks(@Header("Authorization") String authorization, @Query("from") String from,
                        @Query("to") String to);
        ...
        Call<SubstitutionsResponse> getSubstitutions(@Header("Authorization") String authorization,
